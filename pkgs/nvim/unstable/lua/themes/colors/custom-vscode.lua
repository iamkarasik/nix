...
local function set_highlights()
  ...
  hl(0, 'PmenuSel', { fg = isDark and c.vscPopupFront or 'none', bg = isDark and c.vscPopupHighlightBlue or c.vscTabOutside })
  ...
  -- NvimTree
  hl(0, 'NvimTreeRootFolder', { fg = colors.fg, bg = 'NONE', bold = true })
  ...
  hl(0, 'BlinkCmpLabel', { fg = colors.fg, bg = 'NONE' })
